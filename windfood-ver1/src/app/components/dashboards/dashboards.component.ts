...
export class DashboardsComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.options2 = this.dashboardService.buildPieChart('Phân bổ số khách hàng mua hàng', 'Asset Allocation', [
      { name: 'Đối tượng khác', y: 33 },
      { name: 'Nghiện chích ma túy(NCMT)', y: 33 },
      { name: 'Công nhân', y: 33 },
    ]
    )

    this.options3 = this.dashboardService.buildPieChart('Phân bổ số XN theo nhóm đối tượng (1/1/2023 - 3/5/2023)', '', [
      { name: 'Lao động xa nhà', y: 6 },
      { name: 'Công nhân', y: 6 },
      { name: 'Phụ nữ mang thai', y: 13 },
      { name: 'Nghiện chích ma túy(NCMT)', y: 6 },
      { name: 'Nam khám tuyển nghĩa vụ quân sụ', y: 6 },
      { name: 'Sinh viên', y: 13 },
      { name: 'Đối tượng khác', y: 50 },
    ],
    )
